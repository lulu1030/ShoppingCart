					...
					<div class="invoice-detail"> 发票抬头： 
						<div class="radio-box"> 
							<label> 
								...
								<span class="blue-radio" :class="{'blue-radio-on':invoice.personal}"  @click="choseInvoice(true)"><a></a></span>  个人
							</label> 
							<label> 
								<input type="radio" class="hide"> 
								<span class="blue-radio" :class="{'blue-radio-on':!invoice.personal}" @click="choseInvoice(false)"><a></a></span>  单位
							</label> 
						</div> 
			...
			<div class="gray-box">
				...
				<div class="box-inner"> 
					<div class="order-discount-line"> 
						...
						<p> 运费： <span>+ ¥ {{fright}}.00</span> </p>  
						<p class="discount-line js-discount-cash"> <em>现金券</em>： <span> - 0 </span> </p>  
					</div> 
				</div>
				<div class="box-inner"> 
					<div class="last-payment clear"> 
						<span class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout"> <a>提交订单</a> </span> <span class="prices fn-right">应付金额： <em>¥ {{checkedPrice+fright}}.00</em></span> 
					</div> 
				</div>
			</div>
		</div>
		<address-add v-if="addressAdd" @close="closeAdd"></address-add>
	</div>
</template>
<script>
